    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-5 px-5">
                <p class="mb-3 fs-3 text-primarys">Register | laH?shop</p>
                <form action="{{ route('register') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <input type="text" class="form-control text-primarys @error('name') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        <input type="email" class="form-control text-primarys @error('email') is-invalid @enderror"
                    ...
                    <button type="submit" class="btn btn-secondarys">Register</button>
                </form>
            </div>
        </div>
    </div>
